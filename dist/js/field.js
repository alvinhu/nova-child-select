...
Nova.booting(function (Vue, router, store) {
    Vue.component('index-child-select', __webpack_require__(3));
    Vue.component('detail-child-select', __webpack_require__(6));
    Vue.component('form-child-select', __webpack_require__(9));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        this.watchedComponents.forEach(function (component) {
            ...
            component.$watch(attribute, function (value) {
                _this.parentValues[component.fieldAttribute] = value && attribute == "selectedResource" ? value.value : value;
                ...
                console.log(_this.parentValues);
    ...
    methods: {
        ...
        updateOptions: function updateOptions() {
            ...
            if (this.parentValue != {}) {
                Nova.request().post("/nova-vendor/child-select/options?resource=" + this.resourceName, {
                    ...
                    _this3.options.forEach(function (option) {
                        if (option.value == _this3.field.value) {
        ...
        isWatchingComponent: function isWatchingComponent(component) {
            return component.field !== undefined && this.field.parentAttributes.includes(component.field.attribute);
        }
    }
});
      ...
      _c("template", { slot: "field" }, [
        _c(
          "select",
          {
            ...
            attrs: { id: _vm.field.attribute, disabled: _vm.disabled },
            on: {
